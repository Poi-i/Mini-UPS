    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('TRAVELING', 'traveling'), ('IDLE', 'idle'), ('ARRIVE WAREHOUSE', 'arrive warehouse'), ('LOADING', 'loading'), ('DELIVERING', 'delivering')], max_length=128)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('x', models.IntegerField()),
                ('y', models.IntegerField()),
                ('status', models.CharField(choices=[('loading', 'loading'), ('delivered', 'delivered'), ('in WH', 'in WH'), ('delivering', 'delivering'), ('loaded', 'loaded')], max_length=128)),
